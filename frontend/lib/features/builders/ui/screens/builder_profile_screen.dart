...
final sampleBuilderProfile = BuilderProfile(
  id: '1',
  name: 'Alex Johnson',
  avatarUrl: null, // Use initial avatar
  coverPhotoUrl: null,
  headline: 'Senior Flutter Developer | Open Source Enthusiast',
  ...
  bio:
      'Passionate Flutter developer with over 5 years of experience building mobile applications. I love open source and community building.',
  skills: ['Flutter', 'Dart', 'Firebase', 'Clean Architecture', 'Bloc', 'Riverpod', 'Python', 'Machine Learning', 'SQL'],
  projects: [
    BuilderProject(
      id: 'p1',
      title: 'Magna App',
      description: 'The official mobile app for Magna Coders community.',
      techStack: ['Flutter', 'Firebase', 'Bloc'],
      status: 'In Progress',
      link: 'https://github.com/magnacoders/app',
    ),
    BuilderProject(
      id: 'p2',
      title: 'E-Commerce UI Kit',
      description: 'A comprehensive UI kit for e-commerce apps.',
      techStack: ['Flutter', 'UI/UX'],
      status: 'Completed',
    ),
  ],
  activities: [
    BuilderActivity(
      id: 'a1',
      icon: Icons.code,
      description: 'Contributed to Magna App',
      timestamp: DateTime.now().subtract(const Duration(days: 2)),
    ),
    BuilderActivity(
      id: 'a2',
      icon: Icons.article,
      description: 'Posted an article on Medium',
              ...
              SliverPersistentHeader(
                ...
                delegate: _SliverAppBarDelegate(
                  TabBar(
                    ...
                    unselectedLabelColor: Theme.of(context).brightness == Brightness.dark ? Colors.grey.shade400 : Colors.grey,
                    ...
                    child: Stack(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: Theme.of(context).scaffoldBackgroundColor, // Match card/scaffold bg
                            shape: BoxShape.circle,
                          ),
                          child: CircleAvatar(
                            radius: 50,
                  ...
                  children: [
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: const LinearGradient(
                            colors: [Color(0xFFFF9940), Color(0xFFE70008)], // Orange to Red
                          ),
                    ...
                    Expanded(
                      child: OutlinedButton(
                        ...
                        child: Text('Message', style: TextStyle(color: Theme.of(context).brightness == Brightness.dark ? Colors.white : Colors.black)),
                      ),
                    ),
                  ],
                ),
      ...
      children: [
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                  if (profile.githubUrl != null || profile.linkedinUrl != null || profile.twitterUrl != null || profile.whatsappUrl != null)
                    Wrap(
                      spacing: 12,
                      runSpacing: 8,
                      children: [
                        if (profile.githubUrl != null)
                          _SocialLinkItem(
                            link: BuilderSocialLink(type: 'github', label: 'GitHub', url: profile.githubUrl!),
                          ),
                        if (profile.linkedinUrl != null)
                          _SocialLinkItem(
                            link: BuilderSocialLink(type: 'linkedin', label: 'LinkedIn', url: profile.linkedinUrl!),
                          ),
                        if (profile.twitterUrl != null)
                          _SocialLinkItem(
                            link: BuilderSocialLink(type: 'twitter', label: 'Twitter', url: profile.twitterUrl!),
                          ),
                        if (profile.whatsappUrl != null)
                          _SocialLinkItem(
                            link: BuilderSocialLink(type: 'whatsapp', label: 'WhatsApp', url: profile.whatsappUrl!),
                          ),
                      ],
                    ),
              ],
        ...
        AppCard(
          child: Padding(
            ...
            child: Column(
              children: [
                _buildStatRow('Connections', profile.connectionsCount.toString()),
                const Divider(),
                  ...
                  Container(
                    ...
                    child: const Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 6),
                        Text('Available for work', style: TextStyle(color: Colors.green, fontWeight: FontWeight.w500)),
                      ],
                    ),
                  )
                else
                  const Text('Not currently looking for new opportunities.', style: TextStyle(color: Colors.grey)),
              ],
            ),
          ),
        ),
                  ...
                  InkWell(
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(width: 4),
                        Text('View Project', style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.w500)),
                      ],
                    ),
                  ),
                ],
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          ...
          leading: CircleAvatar(
            backgroundColor: Colors.grey.shade200,
            backgroundImage: connection.avatarUrl != null ? NetworkImage(connection.avatarUrl!) : null,
            child: connection.avatarUrl == null ? Text(connection.name[0]) : null,
          ),
